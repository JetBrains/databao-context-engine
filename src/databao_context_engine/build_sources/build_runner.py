    ...
    *,
    ...
    try:
        ...
        if should_enrich_context:
            result = build_service.enrich_built_context(result)
        ...
        if should_index:
            ...
            build_service.index_built_context(built_context=result, context_hash=context_hash)
    ...
    *,
    ...
    for context in contexts:
        try:
            ...
            result = _index_one_context(context=context, build_service=build_service)
...
def _index_one_context(
    *,
    ...
    try:
        build_service.index_datasource_context(context=context)
