...
## Overview
This project integrates database introspection, dbt metadata, and document embeddings to create a unified data context engine.
...
## Summary
Once completed, the system will allow querying across databases, dbt models, and raw files — a single interface for exploring data knowledge.